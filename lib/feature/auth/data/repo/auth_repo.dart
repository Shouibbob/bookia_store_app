...
import 'package:bookia_store_app/feature/auth/data/models/response/login_response_model/login_response_model.dart';
import 'package:bookia_store_app/feature/auth/data/models/response/register_response_model/register_response_model.dart';
...
class AuthRepo {
  ...
  static Future<LoginResponseModel?> login(LoginParams params) async {
    try {
